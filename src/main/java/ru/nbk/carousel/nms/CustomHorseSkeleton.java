...
public class CustomHorseSkeleton extends EntityHorseSkeleton implements CarouselHorse {

    private double correction;
    private boolean isReverced;
    private Consumer<CarouselHorse> onTick;

    public CustomHorseSkeleton(Location location, double correction, boolean isReverced) {
    ...
    public HorseType getType() {
        return HorseType.HORSE_SKELETON;
    }
